...
#
#
#     def merge_with_flow_configuration(self, conf2:dict):
#         Check.not_none(self._flow_configuration, "Cannot merge a flow configuration 2 if flow configuration 1 is not created yet.")
#
#
#
#         abs1 = self._flow_configuration["_activityBlocks"]
#         abs2 = conf2["_activityBlocks"]
#
#         conf1 = self._flow_configuration
#
#
#         # ------------- add activity ------------- #
#         # flow_config2 should have only 1 activity block and 1 activity. Get that activity
#         activities1:list = conf1["_activityBlocks"][self._activity_block_id]["_activities"]
#         activities2:list = conf2["_activityBlocks"][self._activity_block_id]["_activities"]
#         activities1.append(activities2[0])
#
#         extensions1:list = conf1.get("extensions",[])
#         extensions2:list = conf2.get("extensions",[])
...
#
#         activity_blocks: dict = {}
#         flow_config['_activityBlocks'] = activity_blocks
#
#         activity_block: dict = {}
#         activity_blocks[self._activity_block_id] = activity_block
#
#         activities: list = []
#         activity_block['_activities'] = activities
#
#         activity: dict = {}
#         activities.append(activity)
#         activity['type'] = activity_type
...
#
#     def _print_to_file(self):
#         with open(self._flow_config_url, 'w') as outfile:
#             yaml.dump(self._flow_configuration, outfile, default_flow_style=False, sort_keys = False)
#
#         # Log the created flow configuration.
#         logging.debug('')
#         logging.debug('')
...
#         logging.debug('')
#
#         yaml_flow_config = yaml.dump(self._flow_configuration, sort_keys=False)
#         lines = yaml_flow_config.split('\n')
#         for line in lines:
#             logging.debug(line)
