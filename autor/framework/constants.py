...
class ContextPropertyPrefix(Constant):
    inp_default = "_inpDef_"
    inp_provide = "_inpVal_"
    cfg_default = "_cfgDef_"
    cfg_provide = "_cfgVal_"
    out_provide = "_outVal_"
    props = "_props"
...
class InterruptMode(Constant):
    INTERRUPT_DESCENDANT_ACTIVITIES = "INTERRUPT_DESCENDANT_ACTIVITIES"
    INTERRUPT_ALL_ACTIVITIES = "INTERRUPT_ALL_ACTIVITIES"
